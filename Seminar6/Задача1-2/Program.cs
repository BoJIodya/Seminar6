// *Печать промежуточных массивов обусловлена необходимостью тестирования.
// *В данном случае оставляю печать этих массивов, что бы было проще проверить работу и увидеть логику решений.
